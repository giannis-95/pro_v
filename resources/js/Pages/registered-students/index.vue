        ...
        <div class="container">
            <div class="row">
                <div class="col text-center mt-4 mb-2">
                    <h4>Έγγεγραμένοι Χρήστες για το Μάθημα {{ props.course.title }}</h4>
                </div>
            </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr v-for="registered_student in registered_students.data" :key="registered_student.id">
                        ...
                        <td>
                            <button @click="openUnregistrationStudentModal(registered_student)" type="button" class="btn btn-danger" title="Απεγγραφή">
                ...
                <AddStudents :students="students" @confirm-add-students="storeStudents"/>
                <UnregistrationStudent :course="course" :unregistered_student="unregistered_student" @confirm-unregistration="unregistrationStudents"/>
            </table>
...
<script setup>
    ...
    const unregistered_student = ref(null);
    ...
    function openUnregistrationStudentModal(registered_student){
        unregistered_student.value = registered_student;
    ...
    function unregistrationStudents(course,unregistered_student){
        ...
        router.delete(`/courses/${course.id}/unregistered-students/${unregistered_student.id}`,{
            course:course
        },{
